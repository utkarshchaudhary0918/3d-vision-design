      ...
      {showOverlay && (
        <>
          ...
          <motion.div 
            ...
            className="absolute top-6 left-6 w-16 h-16 border-l-2 border-t-2 border-primary/30" 
          />
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.15 }}
            className="absolute top-6 right-6 w-16 h-16 border-r-2 border-t-2 border-primary/30" 
          />
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.2 }}
            className="absolute bottom-6 left-6 w-16 h-16 border-l-2 border-b-2 border-primary/30" 
          />
          <motion.div 
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
